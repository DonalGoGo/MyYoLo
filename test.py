...
def generateOneSampleByXml(ImgPath,xml_file_path):
    ...
    for index in range(len(objnames)):
        ...
        xmax=int(objboubd[2])
        ymax=int(objboubd[3])
        init_img=cv2.rectangle(init_img,(xmin,ymin),(xmax,ymax),(150,20,200),2)
        cv2.imwrite("C:/Users/Test/Desktop/Yolo/1.jpg",init_img)
...
# cv2.imshow("1",img)
# cv2.imwrite("C:/Users/Test/Desktop/Yolo/1.jpg",img)
# print("")
train_set, valid_set = splitTrainAndValid(AnnoPath)
generateFinalDataSet(ImgPath, AnnoPath, train_set, BATCH_SIZE)
